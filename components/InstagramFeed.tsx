...
const InstagramFeed: React.FC = () => {
    useEffect(() => {
        ...
        // If the script is already loaded (navigating back and forth), force re-process
        ...
        <section className="py-16 bg-white">
            <div className="container mx-auto px-4">
                <div className="text-center mb-10 reveal-on-scroll">
                    <h2 className="font-serif text-3xl md:text-4xl font-bold text-primary-teal mb-4">Latest Updates</h2>
                    <p className="text-lg text-gray-600">Follow us on Instagram <a href="https://www.instagram.com/hijama_london" target="_blank" rel="noreferrer" className="text-primary-gold font-bold hover:underline">@hijama_london</a></p>
                </div>

                <div className="flex justify-center reveal-on-scroll delay-200">
                    <blockquote 
                        className="instagram-media" 
                        data-instgrm-captioned 
                        data-instgrm-permalink="https://www.instagram.com/p/DGvMyNAoU0t/?utm_source=ig_embed&amp;utm_campaign=loading" 
                    ...
                    >
                        <div style={{ padding: '16px' }}> 
                            <a href="https://www.instagram.com/p/DGvMyNAoU0t/?utm_source=ig_embed&amp;utm_campaign=loading" style={{ background: '#FFFFFF', lineHeight: 0, padding: '0 0', textAlign: 'center', textDecoration: 'none', width: '100%' }} target="_blank" rel="noreferrer"> 
                            ...
                            <p style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', lineHeight: '17px', marginBottom: 0, marginTop: '8px', overflow: 'hidden', padding: '8px 0 7px', textAlign: 'center', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                                <a href="https://www.instagram.com/p/DGvMyNAoU0t/?utm_source=ig_embed&amp;utm_campaign=loading" style={{ color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', fontStyle: 'normal', fontWeight: 'normal', lineHeight: '17px', textDecoration: 'none' }} target="_blank" rel="noreferrer">A post shared by Hijama London (@hijama_london)</a>
                            </p>
                        </div>
                    </blockquote>
                </div>
